...
/**
 * aide theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { aideTheme } from './aide';
 *   import './aide.css';
 */
export const aideTheme = {
  name: 'aide',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "Figtree, \"Pretendard Variable\", \"Pretendard JP Variable\", Pretendard, \"Pretendard JP\", -apple-system, BlinkMacSystemFont, system-ui, Roboto, \"Helvetica Neue\", \"Segoe UI\", \"Apple SD Gothic Neo\", \"Noto Sans KR\", \"Malgun Gothic\", \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", sans-serif",
    "--font-family-heading": "Figtree, \"Pretendard Variable\", \"Pretendard JP Variable\", Pretendard, \"Pretendard JP\", -apple-system, BlinkMacSystemFont, system-ui, Roboto, \"Helvetica Neue\", \"Segoe UI\", \"Apple SD Gothic Neo\", \"Noto Sans KR\", \"Malgun Gothic\", \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", sans-serif",
    ...
    "--color-background-body": "light-dark(#f5f6fc, #1b1b1b)",
